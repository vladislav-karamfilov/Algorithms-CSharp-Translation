...
void RandomCycle(int[,] population, int t)
...
int Evaluate(int[,] A, int[,] population, int t)
{ int res = 0;
  for (int i = 0; i < n - 1; i++)
...
void Combine(int[] result, int[,] A, int[,] population, int p1, int p2, int q1, int q2)
{ int[] uq1 = new int[n];
  int[] uq2 = new int[n];
...
void Mutate(int[] result, int[,]A, int[,] population) {
...
void Reproduce(int[] result, int[,] A, int s, int[,] population)
