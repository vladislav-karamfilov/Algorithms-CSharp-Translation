...
class MinAndMaxElement
{
	...
	static void InitializeArray(int[] numbers) /* Запълва масива със случайни числа */
	{
	...
	static void PrintArray(int[] numbers) /* Извежда масива на екрана */
	{
	...
	static int FindMaxElement(int[] numbers) /* Намира максималния елемент */
	{
	...
	static int FindMinElement(int[] numbers) /* Намира минималния елемент */
	{
	...
	static void Swap(ref int element1, ref int element2) /* Разменя стойностите на две променливи */
	{
		int temp = element1;
		element1 = element2;
		element2 = temp;
	...
	static void FindMinAndMax(out int min, out int max, int[] numbers, int n)
	...
	static int FindSecondMax(int[] numbers, int n) /* Намира втория по големина елемент */
	{
		int x = numbers[0];
		int y = numbers[1];
		if (y > x)
